    ...
    <BaseLayout>
      <div className="p-10">
        ...
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          via our application, OptiListen, and its associated services. Personal
          information is any information about you which can be used to identify
          you. This includes information about you as a person (such as name,
          address, and date of birth), your devices, payment details, and even
          information about how you use an app or online service. In the event
          our app contains links to third-party sites and services, please be
          aware that those sites and services have their own privacy policies.
          After following a link to any third-party content, you should read
          their posted privacy policy information about how they collect and use
          personal information. This Privacy Policy does not apply to any of
          your activities after you leave our app. This policy is effective as
          of 4 July 2022. Last updated: 4 July 2022
        </p>
        ...
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          either of these two categories: “voluntarily provided” information and
        ...
        <p className="text-2xl font-sfpro-bold pb-6">Children’s Privacy</p>
        <p className="text-xl font-sfpro-medium pb-6">
          We do not aim any of our products or services directly at children
          under the age of 13, and we do not collect personal information about
          children under 13. (We do not collect personal information at all.)
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">
          Your Rights and Controlling Your Personal Information
        </p>
        <p className="text-xl font-sfpro-medium pb-6">
          The app does not collect your personal information, and thus also does
          not hold, use, or disclose personal information. You do not provide
          personal information to us, and we receive no personal information
          about you from any third party. By law, you may request details of the
          personal information that we hold about you. Because we do not hold
          any personal information about you, in such a case we will have no
          such details to share. Non-discrimination: We will not discriminate
          against you for exercising any of your rights over your personal
          information. We will not deny you goods or services and/or charge you
          ...
          us in respect of any data breach. Complaints: If you believe that we
          ...
          data protection authority in relation to your complaint. Unsubscribe:
          We do not gather email address information at this time and thus will
          not store your email in a database or send communication, marketing
          communications or otherwise, to any email address. In the event that
          future versions of this app offer a method for receiving email
          updates, we will provide an unsubscribe link at the end of all such
          email messages.
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">Business Transfers</p>
        <p className="text-xl font-sfpro-medium pb-6">
          If we or our assets are acquired, or in the unlikely event that we go
          out of business or enter bankruptcy, any data among the assets would
          not include your personal information. You acknowledge that such
          transfers may occur, and that any parties who acquire us may, to the
          extent permitted by applicable law, continue to use acquired data
          according to this policy, which they will be required to assume as it
          is the basis for any ownership or use rights we have over such
          information.
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">Limits of Our Policy</p>
        <p className="text-xl font-sfpro-medium pb-6">
        ...
        <p className="text-2xl font-sfpro-bold pb-6">Changes to This Policy</p>
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          policy, we will post the changes here and on our website. If required
          by law, we will get your permission or give you the opportunity to opt
          in to or opt out of, as applicable, any uses of your personal
          information.
        </p>
        <p className="text-3xl font-sfpro-bold pb-6">
        ...
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          Controller with respect to any personal information you might provide
          to us, if it were possible to do so.
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">
        ...
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          will do so only when we have a legal right to do so. In which case, we
          will collect and use personal information lawfully, fairly, and in a
          transparent manner. If we are ever to seek your consent to process
          your personal information, and you are at that time under 16 years of
          age, we will seek your parent or legal guardian’s consent to process
        ...
        <p className="text-xl font-sfpro-medium pb-6">
          Restrict: While we do not gather any personal information, it is still
          your right to request that we restrict the processing of your personal
          information if (i) you are concerned about the accuracy of your
          personal information; (ii) you believe your personal information has
          been unlawfully processed. Data portability: You may have the right to
          request a copy of any personal information we hold about you. While we
          do not at this time gather or hold any such personal information, if
          we were to do so in the future, then upon request we will provide this
          information in CSV format or other easily readable machine format. You
          may also have the right to request that we transfer any such personal
          information to a third party. Deletion: You may have a right to
          request that we delete any personal information we hold about you at
          any time, and we will take reasonable steps to delete your personal
          information from our current records. If you ask us to delete your
          personal information, we will let you know how the deletion affects
          your use of our app, website or products and services. There may be
          ...
          information within 90 days of the deletion of your account. Please be
        ...
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          to other organizations for their marketing purposes (which is, at this
          time, none at all). To make such a request, please contact us using
          the details provided in this privacy policy with “Request for
          ...
          categories of personal information we revealed to other organizations
        ...
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          we receive information from, review the “We Collect No Personal
          Information” section.
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">
        ...
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          the right to request the following from us: The categories of personal
          information we have collected about you; The categories of sources
          from which the personal information was collected; The categories of
          personal information about you we disclosed for a business purpose or
          sold; The categories of third parties to whom the personal information
          was disclosed for a business purpose or sold; The business or
          commercial purpose for collecting or selling the personal information;
          and The specific pieces of personal information we have collected
          about you. To exercise any of these rights, please contact us using
          the details provided in this privacy policy.
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">Shine the Light</p>
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          manner (if at all) in which we share certain personal information as
          defined by California’s “Shine the Light” with third parties and
          affiliates for their own direct marketing purposes. To receive this
          information, send us a request using the contact details provided in
          this privacy policy. Requests must include “California Privacy Rights
          Request” in the first line of the description and include your name,
          street address, city, state, and ZIP code.
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">Contact Us</p>
        <p className="text-xl font-sfpro-medium pb-6">
          For any questions or concerns regarding your privacy, you may contact
          us using the following details: OptiListen Support
        </p>
        <a
        ...
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          carefully, and keep a copy of them for your reference. The OptiListen
          mobile application supports becoming a better listener by showing the
          percentage of time spent listening (not speaking) in an online audio
          conversation and comparing it to a goal target.
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">Privacy</p>
        <p className="text-xl font-sfpro-medium pb-6">
          Your use of OptiListen is subject to Long Sky's Privacy Policy. Please
          review our Privacy Policy, which also governs this website and informs
        ...
        <p className="text-2xl font-sfpro-bold pb-6">Children Under Thirteen</p>
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          are under 18, you may use OptiListen only with permission of a parent
          or guardian.
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">
        ...
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          Linked Sites are not under the control of Long Sky and Long Sky is not
          ...
          updates to a Linked Site. Long Sky is providing these links to you
          only as a convenience, and the inclusion of any link does not imply
          endorsement by Long Sky of the site or any association with its
          operators.
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">
        ...
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          of use. As a condition of your use of the app, you warrant to Long Sky
          that you will not use OptiListen for any purpose that is unlawful or
          prohibited by these Terms. You may not use the app in any manner which
          could damage, disable, overburden, or impair the service or interfere
          with any other party's use and enjoyment of the application. You may
          ...
          application. All content included as part of the service, such as
          text, graphics, logos, images, as well as the compilation thereof, and
          any software used in the app or in this website, is the property of
          Long Sky or its suppliers and protected by copyright and other laws
          ...
          not make any changes thereto. You will not modify, publish, transmit,
          ...
          or in part, found in the app. Long Sky content is not for resale. Your
          use of the app does not entitle you to make any unauthorized use of
          ...
          licenses, express or implied, to the intellectual property of Long Sky
          or our licensors except as expressly authorized by these Terms.
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">International Users</p>
        <p className="text-xl font-sfpro-medium pb-6">
          The Service is controlled, operated and administered by Long Sky from
          ...
          laws. You agree that you will not use OptiListen in any country or in
          any manner prohibited by any applicable laws, restrictions or
          regulations.
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">Indemnification</p>
        <p className="text-xl font-sfpro-medium pb-6">
          ...
          rules or regulations. Long Sky reserves the right, at its own cost, to
          ...
          cooperate with Long Sky in asserting any available defenses.
        </p>
        <p className="text-2xl font-sfpro-bold pb-6">Arbitration</p>
        <p className="text-xl font-sfpro-medium pb-6">
        ...
        <p className="text-2xl font-sfpro-bold pb-6">Liability Disclaimer</p>
        <p className="text-xl font-sfpro-medium pb-6">
          THE INFORMATION, SOFTWARE, PRODUCTS, AND SERVICES INCLUDED IN OR
          AVAILABLE THROUGH THE SITE MAY INCLUDE INACCURACIES OR TYPOGRAPHICAL
          ERRORS. CHANGES ARE PERIODICALLY ADDED TO THE INFORMATION HEREIN. LONG
          SKY MEDIA AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN
          THE SITE AT ANY TIME. LONG SKY MEDIA AND/OR ITS SUPPLIERS MAKE NO
          ...
          PROVIDED "AS IS" WITHOUT WARRANTY OR CONDITION OF ANY KIND. LONG SKY
          MEDIA AND/OR ITS SUPPLIERS HEREBY DISCLAIM ALL WARRANTIES AND
          ...
          LAW, IN NO EVENT SHALL LONG SKY MEDIA AND/OR ITS SUPPLIERS BE LIABLE
          ...
          CONNECTED WITH THE USE OR PERFORMANCE OF THE SITE, WITH THE DELAY OR
          INABILITY TO USE THE SITE OR RELATED SERVICES, THE PROVISION OF OR
          ...
          LONG SKY MEDIA OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE
        ...
        <p className="text-xl font-sfpro-medium pb-6">
          Long Sky reserves the right, in its sole discretion, to terminate your
          access to the app and the related services or any portion thereof at
          ...
          Long Sky as a result of this agreement or use of the Site. Long Sky's
          ...
          Long Sky's right to comply with governmental, court and law
          enforcement requests or requirements relating to your use of the Site
          or information provided to or gathered by Long Sky with respect to
          ...
          Long Sky with respect to the Site and it supersedes all prior or
          contemporaneous communications and proposals, whether electronic, oral
          or written, between the user and Long Sky with respect to the Site. A
        ...
        <p className="text-2xl font-sfpro-bold pb-6">Changes to Terms</p>
        <p className="text-xl font-sfpro-medium pb-6">
        ...
        <p className="text-xl font-sfpro-medium pt-6">
